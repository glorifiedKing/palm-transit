...
!function(window, document, undefined) {
    ...
    function testRunner() {
        ...
        for (var a in tests)
            if (tests.hasOwnProperty(a)) {
                ...
                for (n = is(e.fn, "function") ? e.fn() : e.fn,
                r = 0; r < A.length; r++)
                    o = A[r],
                    i = o.split("."),
    ...
    function getBody() {
        var A = document.body;
        return A || (A = createElement(isSVG ? "svg" : "body"),
        A.fake = !0),
        A
    }
    function injectElementWithStyles(A, e, t, n) {
        var r, o, i, a, d = "modernizr", s = createElement("div"), l = getBody();
        if (parseInt(t, 10))
            for (; t--; )
                i = createElement("div"),
                i.id = n ? n[t] : d + (t + 1),
                s.appendChild(i);
        return r = createElement("style"),
        r.type = "text/css",
        r.id = "s" + d,
        ...
        docElement.offsetHeight) : s.parentNode.removeChild(s),
        !!o
    }
    ...
    function testProps(A, e, t, n) {
        ...
        for (var i, a, d, s, l, c = ["modernizr", "tspan", "samp"]; !mStyle.style && c.length; )
            i = !0,
    ...
    function testDOMProps(A, e, t) {
        ...
        for (var r in A)
            if (A[r]in e)
                return t === !1 ? A[r] : (n = e[A[r]],
                is(n, "function") ? fnBind(n, t || e) : n);
        return !1
    }
    function testPropsAll(A, e, t, n, r) {
        var o = A.charAt(0).toUpperCase() + A.slice(1)
          , i = (A + " " + cssomPrefixes.join(o + " ") + o).split(" ");
        return is(e, "string") || is(e, "undefined") ? testProps(i, e, n, r) : (i = (A + " " + domPrefixes.join(o + " ") + o).split(" "),
        testDOMProps(i, e, t))
    }
    ...
    Modernizr.addTest("target", function() {
        ...
        if (!("querySelectorAll"in A))
            return !1;
        try {
            return A.querySelectorAll(":target"),
            !0
        } catch (e) {
            return !1
        }
    ...
    Modernizr.addTest("urlparser", function() {
        var A;
        try {
            return A = new URL("http://modernizr.com/"),
    ...
    Modernizr.addTest("websocketsbinary", function() {
        ...
        if ("WebSocket"in window) {
            if (A = "binaryType"in WebSocket.prototype)
                return A;
            try {
    ...
    isSVG || !function(A, e) {
        ...
        function i(A, t, n) {
            ...
            n || (n = o(t));
            var r;
            return r = n.cache[A] ? n.cache[A].cloneNode() : m.test(A) ? (n.cache[A] = n.createElem(A)).cloneNode() : n.createElem(A),
            !r.canHaveChildren || w.test(A) || r.tagUrn ? r : n.frag.appendChild(r)
        }
        function a(A, t) {
            if (A || (A = e),
            c)
            ...
            t = t || o(A);
            for (var r = t.frag.cloneNode(), i = 0, a = n(), d = a.length; d > i; i++)
                r.createElement(a[i]);
            return r
        }
        function d(A, e) {
        ...
        function s(A) {
            A || (A = e);
            var n = o(A);
            return !h.shivCSS || l || n.hasCSS || (n.hasCSS = !!t(A, "article,aside,dialog,figcaption,figure,footer,header,hgroup,main,nav,section{display:block}mark{background:#FF0;color:#000}template{display:none}")),
            c || d(A, n),
            A
        }
    ...
    Modernizr.addAsyncTest(function() {
        ...
        var e, t = 300;
        "ondeviceproximity"in window && "onuserproximity"in window ? (window.addEventListener("deviceproximity", A),
    ...
    Modernizr.addAsyncTest(function() {
        function A() {
            addTest("blobworkers", !1),
            e()
        }
        function e() {
            a && n.revokeObjectURL(a),
            i && i.terminate(),
            d && clearTimeout(d)
        }
        try {
            var t = window.BlobBuilder
              , n = window.URL;
            Modernizr._config.usePrefix && (t = t || window.MozBlobBuilder || window.WebKitBlobBuilder || window.MSBlobBuilder || window.OBlobBuilder,
            n = n || window.MozURL || window.webkitURL || window.MSURL || window.OURL);
            var r, o, i, a, d, s = "Modernizr", l = "this.onmessage=function(e){postMessage(e.data)}";
            try {
                r = new Blob([l],{
    ...
    var hasEvent = function() {
        function A(A, t) {
            var n;
            return A ? (t && "string" != typeof t || (t = createElement(t || "div")),
            A = "on" + A,
            n = A in t,
            !n && e && (t.setAttribute || (t = createElement("div")),
            t.setAttribute(A, ""),
    ...
    Modernizr.addTest("vml", function() {
        ...
        return isSVG || (e.innerHTML = '<v:shape id="vml_flag1" adj="1" />',
        A = e.firstChild,
    ...
    Modernizr.addTest("csscalc", function() {
        var A = "width:"
          , e = "calc(10px);"
          , t = createElement("a");
        return t.style.cssText = A + prefixes.join(e + A),
        !!t.style.length
    }),
    Modernizr.addTest("cubicbezierrange", function() {
        var A = createElement("a");
        return A.style.cssText = prefixes.join("transition-timing-function:cubic-bezier(1,0,0,1.1); "),
        !!A.style.length
    }),
    Modernizr.addTest("cssgradients", function() {
        for (var A, e = "background-image:", t = "gradient(linear,left top,right bottom,from(#9f9),to(white));", n = "", r = 0, o = prefixes.length - 1; o > r; r++)
            A = 0 === r ? "to " : "",
            n += e + prefixes[r] + "linear-gradient(" + A + "left top, #9f9, white);";
    ...
    Modernizr.addTest("opacity", function() {
        var A = createElement("a").style;
        return A.cssText = prefixes.join("opacity:.55;"),
        /^0.55$/.test(A.opacity)
    }),
    ...
    Modernizr.addTest("csspositionsticky", function() {
        var A = "position:"
          ...
          , t = createElement("a")
          , n = t.style;
        return n.cssText = A + prefixes.join(e + ";" + A).slice(0, -A.length),
    ...
    Modernizr.addTest("preserve3d", function() {
        ...
        return t && t.supports && t.supports("(transform-style: preserve-3d)") ? !0 : (A = createElement("a"),
        e = createElement("a"),
    ...
    Modernizr.addTest("dataset", function() {
        var A = createElement("div");
        return A.setAttribute("data-a-b", "c"),
    ...
    Modernizr.addTest("ruby", function() {
        function A(A, e) {
            var t;
            return window.getComputedStyle ? t = document.defaultView.getComputedStyle(A, null).getPropertyValue(e) : A.currentStyle && (t = A.currentStyle[e]),
            t
        }
        function e() {
        ...
        "none" == A(r, o) || "ruby" == A(t, o) && "ruby-text" == A(n, o) || "6pt" == A(r, i) && "6pt" == A(n, i) ? (e(),
        !0) : (e(),
        !1)
    }),
    ...
    Modernizr.addTest("fileinputdirectory", function() {
        ...
        for (var t = 0, n = domPrefixes.length; n > t; t++)
            if (domPrefixes[t] + e in A)
                return !0;
        return !1
    }),
    Modernizr.addTest("formattribute", function() {
        var A, e = createElement("form"), t = createElement("input"), n = createElement("div"), r = "formtest" + (new Date).getTime(), o = !1;
        e.id = r;
        try {
            t.setAttribute("form", r)
        } catch (i) {
            document.createAttribute && (A = document.createAttribute("form"),
            A.nodeValue = r,
    ...
    Modernizr.addAsyncTest(function() {
        ...
        !r && "srcset"in n ? (e = "data:image/gif;base64,R0lGODlhAgABAPAAAP///wAAACH5BAAAAAAALAAAAAACAAEAAAICBAoAOw==",
    ...
    Modernizr.addAsyncTest(function() {
        if (Modernizr.webglextensions = !1,
        Modernizr.webgl) {
            var A, e, t;
            try {
    ...
    Modernizr.addAsyncTest(function() {
        function A(i) {
            ...
            return !a && n > r ? void (e = setTimeout(A, t)) : (o.removeEventListener("playing", A, !1),
            addTest("videoautoplay", a),
            void (o.parentNode && o.parentNode.removeChild(o)))
        }
        var e, t = 200, n = 5, r = 0, o = createElement("video"), i = o.style;
    ...
    Modernizr.addAsyncTest(function() {
        ...
        if (A = !("plugins"in navigator && "Shockwave Flash"in navigator.plugins || e),
        A || isSVG)
            r(!1);
        else {
            var i, a, d = createElement("embed"), s = getBody();
            ...
            i = function() {
                return t(s),
                docElement.contains(s) ? (docElement.contains(d) ? (a = d.style.cssText,
                "" !== a ? r("blocked", d) : r(!0, d)) : r("blocked"),
                void n(s)) : (s = document.body || s,
    ...
    testStyles("#modernizr div {width:1px} #modernizr div:nth-child(2n) {width:2px;}", function(A) {
    ...
    testStyles("#modernizr{position: absolute; top: -10em; visibility:hidden; font: normal 10px arial;}#subpixel{float: left; font-size: 33.3333%;}", function(A) {
        ...
        Modernizr.addTest("subpixelfont", window.getComputedStyle ? "44px" !== window.getComputedStyle(e, null).getPropertyValue("width") : !1)
    }, 1, ["subpixel"]),
    ...
    Modernizr.addTest("formvalidation", function() {
        ...
        if (!("checkValidity"in A && "addEventListener"in A))
            return !1;
        if ("reportValidity"in A)
            return !0;
        var e, t = !1;
        ...
        testStyles("#modernizr form{position:absolute;top:-99999em}", function(n) {
            ...
            e.addEventListener("invalid", function(A) {
                t = !0,
                A.preventDefault(),
                A.stopPropagation()
            }, !1),
    ...
    Modernizr.inputtypes = function(A) {
        for (var e, t, n, r = A.length, o = "1)", i = 0; r > i; i++)
            ...
            docElement.removeChild(inputElem)) : /^(search|tel)$/.test(e) || (n = /^(url|email)$/.test(e) ? inputElem.checkValidity && inputElem.checkValidity() === !1 : inputElem.value != o)),
            inputs[A[i]] = !!n;
        return inputs
    }(inputtypes),
    Modernizr.addTest("localizednumber", function() {
        ...
        return A = "number" === r.type && 1.1 === r.valueAsNumber && r.checkValidity(),
        n.removeChild(e),
    ...
    Modernizr.addTest("hsla", function() {
        ...
        contains(A.backgroundColor, "rgba") || contains(A.backgroundColor, "hsla")
    }),
    Modernizr.addTest("bdi", function() {
        ...
        return docElement.removeChild(A),
        t
    }),
    ...
    testStyles("#modernizr1{width: 50vm;width:50vmin}#modernizr2{width:50px;height:50px;overflow:scroll}#modernizr3{position:fixed;top:0;left:0;bottom:0;right:0}", function(A) {
        var e = A.childNodes[2]
          , t = A.childNodes[1]
          , n = A.childNodes[0]
          , r = parseInt((t.offsetWidth - t.clientWidth) / 2, 10)
    ...
    Modernizr.addTest("cssfilters", function() {
        ...
        var A = createElement("a");
        return A.style.cssText = prefixes.join("filter:blur(2px); "),
        !!A.style.length && (document.documentMode === undefined || document.documentMode > 9)
    }),
        ...
        function A() {
            ...
            function n(A, e) {
                try {
                    ...
                    return r.cssText = "position:absolute;top:0;left:0;overflow:visible;width:1.25em;",
                    t.appendChild(n),
                    ...
                    n.innerHTML = "m" + A + "m",
                    a = n.offsetHeight > o,
                    e ? (n.innerHTML = "m<br />m",
                    o = n.offsetWidth,
                    n.innerHTML = "m" + A + "m",
                    d = n.offsetWidth > o) : d = !0,
                    a === !0 && d === !0 && (i = !0),
            ...
            function r(A) {
                try {
                    var e, t = createElement("input"), n = createElement("div"), r = "lebowski", o = !1, i = document.body.firstElementChild || document.body.firstChild;
                    n.innerHTML = r + A + r,
                    document.body.insertBefore(n, i),
                    document.body.insertBefore(t, n),
                    t.setSelectionRange ? (t.focus(),
                    t.setSelectionRange(0, 0)) : t.createTextRange && (e = t.createTextRange(),
                    e.collapse(!0),
                    e.moveEnd("character", 0),
                    e.moveStart("character", 0),
                    e.select());
                    try {
                        window.find ? o = window.find(r + r) : (e = window.self.document.body.createTextRange(),
                        o = e.findText(r + r))
                    } catch (a) {
                        o = !1
                    }
            ...
            return document.body || document.getElementsByTagName("body")[0] ? (addTest("csshyphens", function() {
                if (!testAllProps("hyphens", "auto", !0))
                    return !1;
                try {
                    return t()
                } catch (A) {
    ...
    Modernizr.addTest("csspseudotransitions", function() {
        ...
        return Modernizr.testStyles(e, function(e) {
            ...
            e.className += "trigger",
            A = "5px" === window.getComputedStyle(e, ":before").getPropertyValue("font-size")
        }),
        A
    }),
    ...
    var prefixed = ModernizrProto.prefixed = function(A, e, t) {
        return 0 === A.indexOf("@") ? atRule(A) : (-1 != A.indexOf("-") && (A = cssToDOM(A)),
    ...
    Modernizr.addAsyncTest(function() {
        ...
        if (A) {
            var t = "modernizr-" + Math.random()
              , n = A.open(t);
            n.onerror = function() {
                n.error && "InvalidStateError" === n.error.name ? addTest("indexeddb", !1) : (addTest("indexeddb", !0),
                detectDeleteDatabase(A, t))
            }
            ,
    ...
    Modernizr.addAsyncTest(function() {
        var A, e, t, n, r = "detect-blob-support", o = !1;
        try {
            A = prefixed("indexedDB", window)
        } catch (i) {}
    ...
    Modernizr.addTest("regions", function() {
        ...
        42 == s ? t = !0 : (docElement.appendChild(n),
        l = n.getBoundingClientRect(),
        n.style[e] = a,
        d = n.getBoundingClientRect(),
        l.height > 0 && l.height !== d.height && 0 === d.height && (t = !0)),
        o = i = r = n = undefined,
        t
    }),
    Modernizr.addTest("wrapflow", function() {
        ...
        n.style.cssText = "position: absolute; left: 50px; width: 100px; height: 20px;" + e + ":end;",
        r.innerText = "X",
        t.appendChild(n),
        t.appendChild(r),
        docElement.appendChild(t);
        var o = r.offsetLeft;
        return docElement.removeChild(t),
        n = r = t = undefined,
        150 == o
    }),
    ...
    Modernizr.addAsyncTest(function() {
        ...
        try {
            var n, r, o = 'var hello = "world"', i = new Blob([o],{
                type: "text/javascript"
            }), a = URL.createObjectURL(i), d = new Worker(a);
            d.onerror = A,
            r = setTimeout(A, 200),
            n = new ArrayBuffer(1),
            d.postMessage(n, [n]),
